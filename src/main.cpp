                    ...
                    if (event == "telemetry") {
                      ...
                      for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                        ...
                        if ( car_lane == lane ) {
                          ...
                          stra |= check_car_s > car_s && check_car_s - car_s < 30;
                        } else if ( car_lane - lane == -1 ) {
                          
                          left |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                        } else if ( car_lane - lane == 1 ) {
                          
                          right |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                        }
                      }
